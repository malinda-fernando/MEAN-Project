...
import { getCartItems, getCartItemsCount, getCartSubTotal, getEstimatedTax, getOrderTotal, getShippingCost } from '@core/cart/cart-selectors';
...
export class PaypalCheckoutComponent implements OnInit, OnDestroy {
  ...
  get paypalConfig(){
    return{
      ...
      env:"sandbox",
      client:{sandbox:"AcqyoTf0zvZQEcuehurhzR4_VJ1_YpP0JAjhC6JgeRhKZIdLAydSvb0FQcEooYEDRGqFSEgffQxl0DPO"},
      commit: true,
